...
int main(int argc, char* argv[])
{
	...
	//CHEAT CODES
	std::srand(NULL);
	LPCWSTR title = L"ASCII TETRIS";
	SYDECredits::_GAMETITLE = "ASCII TETRIS";
	...
	while (true)
	{
		window = SYDEGamePlay::play(&Tetrisyde, start, hOut, window, windowWidth, windowHeight, deltaTime);
